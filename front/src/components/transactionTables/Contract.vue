<template>
  <div class="table-wrap">
    ...
    >
      ...
      <el-table-column
        align="center"
        :label="$t('transaction.contractAddress')"
        show-overflow-tooltip
      >
        <template slot-scope="scope">
          <span class="link" @click="_mixin_address_jump(scope.row.contractId)">{{scope.row.contractId}}</span>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
        :label="$t('transaction.authorAddress')"
        show-overflow-tooltip
      >
        <template slot-scope="scope">
